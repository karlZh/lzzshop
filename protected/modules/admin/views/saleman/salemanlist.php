...
<div class="pageheader">
    <h2><i class="fa fa-user" style="line-height: 48px;padding-left: 1px;"></i> 业务员管理 <span> 业务员列表</span></h2>
    ...
    <div class="breadcrumbs">
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $this->createUrl('admin/index') ?>">业务员管理</a></li>
...
<section class="tile color transparent-black">
    ...
    <div class="tile-body nopadding">
        ...
        <table class="table table-bordered table-sortable">
            ...
            <tbody>
            <?php foreach($salemanList as $user): ?>
                <tr>
                    <td>
                        <div class="checkbox check-transparent">
                    ...
                    <td><?php echo $user->salemanuser ?></td>
