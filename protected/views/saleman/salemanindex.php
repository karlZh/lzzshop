...
<div id="content" class="col-md-12">
    ...
    <div class="pageheader">
        ...
        <h2><i class="fa fa-tachometer"></i> 业务员统计
            <span></span></h2>
                      ...
                      <span class="pull-left">
                        <i class="fa fa-users media-object"></i>
                            ...
                            <div class="media-body">
                                <small>客户总数</small>
                                <h2 class="media-heading animate-number" data-value="<?php echo $memberCount?>" data-animation-duration="1500">0</h2>
                            </div>
                        </div>
                    </div>
                    <div class="back">
                      ...
                      <span class="pull-left">
                        <i class="fa fa-shopping-cart media-object"></i>
                            ...
                            <div class="media-body">
                                ...
                                <h2 class="media-heading animate-number" data-value="<?php echo $salemanInfo->tot_sales;?>" data-animation-duration="1500">0</h2>
                            </div>
                        </div>
                    </div>
                    <div class="back">
                    ...
                    <div class="front">
                      ...
                      <span class="pull-left">
                        <i class="fa fa-usd media-object"></i>
                            ...
                            <div class="media-body">
                                <small>Sales</small>
                                <h2 class="media-heading animate-number" data-value="<?php $salemanInfo->push_money;?>" data-animation-duration="1500">0</h2>
                            </div>
                        </div>
